...
dd = 0.009;
genmax = 5000; % the number of generations for simulations
% WT
meanVb0 = NaN(30,1);
CVVb0 = NaN(30,1);
RVbVd0 = NaN(30,1);
for i = 1:30
    [meanVb0(i),CVVb0(i)] = stochastictrace(0.05+i*0.005,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);
end
...
RVbVd = NaN(30,1);
for i = 1:30
    [meanVb(i),CVVb(i)] = stochastictrace(0.05+i*0.005,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);
end