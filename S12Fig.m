...
K_n(3:2+gx) = linspace(9000,15000,gx);
K_n(3+gx:2+2*gx) = linspace(750,1250,gx);
...
% WT
[meanVb0,CVVb0,Vb0] = stochastictrace2(threshold,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);

% delete one inhibitor
g(5+gx) = 0;
m_0(5+gx) = 0;
p_0(5+gx) = 0;
[meanVb,CVVb,Vb] = stochastictrace2(threshold,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);

% delete two inhibitors
g(4+gx) = 0;
m_0(4+gx) = 0;
p_0(4+gx) = 0;
[meanVb1,CVVb1,Vb1] = stochastictrace2(threshold,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);