...
RVbVd0 = NaN(35,1);
for i = 1:35
    [meanVb0(i),CVVb0(i)] = stochastictrace(0.25+i*0.02,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);
end
...
RVbVd = NaN(35,1);
for i = 1:35
    [meanVb(i),CVVb(i)] = stochastictrace(0.25+i*0.02,dd,genmax,m_0,p_0,tmax,ntot,rho,a,g,L,Gamma_n,K_n,v_n,tau_m,Gamma_r,K_r,v_r,tau_p,gx);
end